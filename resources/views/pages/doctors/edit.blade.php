                ...
                <div class="card">
                    <form action="{{ route('doctors.update', $doctor) }}" method="POST">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label>Foto</label>
                                <input type="string" class="form-control" name="foto" value="{{ $doctor->phone }}">
                            </div>
                            <div class="form-group">
                                <label>Specialist</label>
                                <input type="string" class="form-control" name="address" value="{{ $doctor->phone }}">
                            </div>
                            <div class="form-group">
                                <label>SIP</label>
                                <input type="number" class="form-control" name="sip" value="{{ $doctor->phone }}">
                            </div>
